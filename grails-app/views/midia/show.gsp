		...
		<div id="show-midia" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${midiaInstance?.id}" />
					<g:link class="edit" action="edit" id="${midiaInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
