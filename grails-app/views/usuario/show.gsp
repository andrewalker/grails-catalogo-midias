	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
                ...
                <li><a href="${createLink(uri: '/logout')}"><g:message code="default.logout.label" default="Sair" /></a></li>
			</ul>
		</div>
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<g:if test="${usuarioInstance?.midias}">
				<li class="fieldcontain">
					<span id="midias-label" class="property-label"><g:message code="usuario.midias.label" default="Midias" /></span>
					
						<g:each in="${usuarioInstance.midias}" var="m">
